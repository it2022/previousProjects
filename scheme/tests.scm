...
(lambda (d) (/2 3 `0))
; expect (lambda (d) (/2 3 (quasiquote 0)))
...
(begin (define hihi (list 'hihihihi)) (cons hihi (list 'hihihi)) (display (car hihi)) (cdr hihi))
;expect hihihihi()
