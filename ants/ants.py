...
class Ant(Insect):
    ...
    def can_contain(self, other):
        if self.is_container and self.can_contain(other) and not other.is_container:
            return True
        else:
            return False
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        radius = 0
        while place != hive:
            if self.min_range <= radius <= self.max_range:
    ...
    def action(self, colony):
        ...
        if self.digestion > 0:
            ...
            if self.place.bees != []:
                ...
                self.digestion = self.time_to_digest
        # END Problem 6
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        # BEGIN Problem 13
        QueenAnt.queenCheck.append(self)
        if self == QueenAnt.queenCheck[0]:
            self.name = 'Queen'
            self.powered_upAnts = []
        else:
            self.name = 'Impostor'
    ...
    def action(self, colony):
        ...
        if self.name == "Queen":
            ...
            while place.exit:
                ...
                if place.ant:
                    ant = place.ant
                    if ant not in self.powered_upAnts:
                        ant.damage = ant.damage * 2
                        self.powered_upAnts.append(ant)

                    if ant.is_container == True:
                        contained_ant = ant.contained_ant
                        if contained_ant and contained_ant not in self.powered_upAnts:
                            contained_ant.damage = contained_ant.damage * 2
                            self.powered_upAnts.append(contained_ant)
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 13
        Ant.reduce_armor(self, amount)
        if self.name == "Queen" and self.armor == 0:
            bees_win()
        # END Problem 13
...
def make_scare(action, bee):
    ...
    """
    # BEGIN Problem EC
    def scary_move(colony):
     if bee.is_scared == False and bee.scareCount<2:
        bee.is_scared = True
        action(colony)
        bee.scareCount += 1
        bee.is_scared = False
